...
export const getPosts = (api, data, limit = 10, page = 1) => async dispatch => {
    ...
    try {
        ...
        dispatch({ type: GET_POSTS_ERROR, payload: error.response.data.message });
    }
}
...
export const createPost = (api, post) => async dispatch => {
    ...
    try {
        ...
        dispatch({ type: CREATE_POST_ERROR, payload: error.response.data.message });
    }
}
...
export const updatePost = (api, post) => async dispatch => {
    ...
    try {
        ...
        dispatch({ type: UPDATE_POST_ERROR, payload: error.response.data.message });
    }
}
...
export const deletePost = (api, id) => async dispatch => {
    ...
    try {
        ...
        dispatch({ type: DELETE_POST_ERROR, payload: error.response.data.message });
    }
}
...
export const getLatestPosts = (api, data, limit = 10) => async dispatch => {
    ...
    try {
        ...
        dispatch({ type: GET_LATEST_POSTS_ERROR, payload: error.response.data.message });
    }
}
