...
function addService() {
  ...
  async function publishService() {
    ...
    try {
      ...
      toast.success(`Service ${serviceTitle} Published`, {
        position: "top-center",
        autoClose: 5000,
      ...
      setTimeout(() => {
        router.push("/admin/services/edit/" + responseData.success.slug);
      }, 2000);
    } catch (error) {
            ...
            <div className="col-span-3">
              <div className="bg-white p-4 rounded-xl">
                ...
                <div className="grid mt-4 text-center">
                  ...
                  <button className="previewBtn" onClick={publishService}>
                    Publish Service
                  </button>
