                        ...
                        <section className="text-gray-600 body-font">
                            <div className="container mx-auto">
                                <div className="flex flex-col text-center w-full mb-12">
                                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Add Contact</h1>
                                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Add New Contact To FinoMail (Please Fill All The Mandatory Details Below)</p>
                                </div>
                                    ...
                                    <div className="mx-auto">
                                        <div className="">
                                            ...
                                            <div className="p-2 w-full">
                                                <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg my-8">Add Contact</button>
                                            </div>
